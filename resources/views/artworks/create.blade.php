            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('artworks.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <x-input-label for="image" :value="__('Artwork Image')" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required></textarea>
                        </div>

                        <div class="mb-4">
                            <x-input-label for="tags" :value="__('Tags (Optional, separate by comma)')" />
                            <x-text-input id="tags" class="block mt-1 w-full" type="text" name="tags" placeholder="cyberpunk, blue, abstract" />
                        </div>
